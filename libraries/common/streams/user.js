 ...
 * @type {Observable}
 */
export const userWillLogin$ = main$.pipe(
 ...
 * @type {Observable}
 */
export const userLoginResponse$ = main$.pipe(
  filter(({ action }) => (
 ...
 * @type {Observable}
 */
export const userDidLogin$ = main$.pipe(
 ...
 * @type {Observable}
 */
export const userWillLogout$ = main$.pipe(
 ...
 * @type {Observable}
 */
export const userDidLogout$ = main$.pipe(
 ...
 * @type {Observable}
 */
export const userDidUpdate$ = main$.pipe(
  filter(({ action }) => (
 ...
 * @type {Observable}
 */
export const userDataReceived$ = userDidUpdate$.pipe(
 ...
 * @type {Observable}
 */
export const loginDidFail$ = main$.pipe(
 ...
 * @type {Observable}
 */
export const legacyConnectRegisterDidFail$ = main$.pipe(
